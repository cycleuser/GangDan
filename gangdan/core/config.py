...
TRANSLATIONS = {
    ...
    "use_images": {
        ...
        "en": "Use Images",
        "ja": "画像を使用",
        "fr": "Utiliser les Images",
        "ru": "Использовать Изображения",
        "de": "Bilder Verwenden",
        "it": "Usa Immagini",
        "es": "Usar Imágenes",
        "pt": "Usar Imagens",
    ...
    "output_length": {
        ...
        "en": "Output Length",
        "ja": "出力長",
        "fr": "Longueur de Sortie",
        "ru": "Длина Вывода",
        "de": "Ausgabelänge",
        "it": "Lunghezza Output",
        "es": "Longitud de Salida",
        "pt": "Comprimento da Saída",
        "ko": "출력 길이",
    },
    "words": {
        "zh": "字",
    ...
    "select_kbs": {
        ...
        "ja": "ナレッジベースを選択",
        "fr": "Sélectionner KBs",
        "ru": "Выбрать Базы Знаний",
        "de": "Wissensdatenbanken Auswählen",
        "it": "Seleziona KB",
        "es": "Seleccionar Bases de Conocimiento",
        "pt": "Selecionar Bases de Conhecimento",
        "ko": "지식 베이스 선택",
    },
    "select_all": {
        "zh": "全选",
