...
from ..core.config import CHROMA_DIR, CONFIG, DATA_DIR, sanitize_kb_name
...
class CustomKBManager:
    ...
    def create_kb(
        ...
        from ..core.config import save_user_kb
    ...
    def _semantic_search(
        ...
        try:
            from ..search.adaptive_search import adaptive_embed, get_current_model_dimension
