...
"es": "Exportar archivos sin procesar",
},
...
"export_success": {
"zh": "已导出 {0} 个文件",
"en": "Exported {0} file(s)",
"ja": "{0} ファイルをエクスポートしました",
"ko": "{0}개 파일 내보내기 완료",
"fr": "{0} fichier(s) exporté(s)",
"de": "{0} Datei(en) exportiert",
"ru": "Экспортировано файлов: {0}",
"es": "{0} archivo(s) exportado(s)",
},

"export_success_all": {
"zh": "全部文件已导出",
"en": "All files exported",
"ja": "全ファイルをエクスポートしました",
"ko": "전체 파일 내보내기 완료",
"fr": "Tous les fichiers exportés",
"de": "Alle Dateien exportiert",
"ru": "Все файлы экспортированы",
"es": "Todos los archivos exportados",
},
"export_report": {
"zh": "导出报告",
"en": "Export Report",
