...
from ..core.constants import PAPERS_DIR_NAME
from ..document.pdf_converter import PDFConverter
from ..document.pdf_downloader import PDFDownloadManager
from ..document.pdf_renamer import PDFRenamer
from ..search.query_expander import QueryExpander
from .models import PaperMetadata, PaperRecord
...
class ResearchPipeline:
    ...
    def search(
        ...
        if should_expand and self.expander is None:
            # Lazy import removed: use factory pattern instead
    ...
    def get_paper_details(self, paper_id: str) -> Optional[PaperMetadata]:
        ...
        """
        from ..search.research_searcher import SemanticScholarFetcher
